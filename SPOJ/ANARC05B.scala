...
object Main extends App{
	...
	@tailrec def merge(l1:List[Int],l2:List[Int],l1sum:Int,l2sum:Int) = {
		if(l1.isEmpty && l2.isEmpty) max(l1sum,l2sum)
		else if(l1.isEmpty) merge(l1,l2.tail,l1sum,l2.head+l2sum)
		else if(l2.isEmpty) merge(l1.tail,l2,l1.head+l1sum,l2sum)
		if(l1.head==l2.head) max(l1sum,l2sum) + l1.head + merge(l1.tail,l2.tail,0,0)
		else if(l1.head<l2.head) merge(l1.tail,l2,l1.head+l1sum,l2sum)
		else merge(l1,l2.tail,l1sum,l2.head+l2sum)

	}

	read22.map{ case(l1,l2) =>
